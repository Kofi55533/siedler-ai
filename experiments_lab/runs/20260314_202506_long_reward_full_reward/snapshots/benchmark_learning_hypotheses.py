...
def _build_policy_kwargs(env: SiedlerScharfschuetzenEnv) -> Dict[str, object]:
    return {
        "net_arch": [64],
...
def train_and_measure(
    ...
    env = _make_env(reward_profile, seed=seed, max_time_override=max_time_override)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--group", choices=("reward", "hyper", "all"), default="reward")
...
def main() -> int:
    ...
    _snapshot_run_context(run_dir, args, candidates)
